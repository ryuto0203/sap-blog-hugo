...
```mermaid
erDiagram
    クライアント ||--o{ コントローリングエリア : "含む"
    コントローリングエリア ||--o{ 会社コード : "含む"
    会社コード ||--o{ プラント : "含む"
    プラント ||--o{ 保管場所 : "含む"
    会社コード ||--o{ 販売組織 : "含む"
    会社コード ||--o{ 購買組織 : "含む"
    購買組織 }o--o{ プラント : "任意の紐付け"
    販売組織 }o--o{ プラント : "流通チャネル経由"
```
...
<div style="font-size: 0.8rem; color: #666; margin-top: 0.5rem; padding: 0.4rem 0.75rem; background: #f8f8f8; border-radius: 4px; display: flex; flex-wrap: wrap; gap: 0.25rem 1.5rem;">
  <span>凡例</span>
  <span><strong>||--o{</strong> 1対多（上位が下位を含む）</span>
  <span><strong>}o--o{</strong> 多対多（任意の紐付け）</span>
  <span>ラベル = 関係の意味</span>
</div>
...
```mermaid
erDiagram
    グローバルメーカー_クライアント ||--|{ 日本法人_会社コード : "含む"
    グローバルメーカー_クライアント ||--|{ 米国法人_会社コード : "含む"
    日本法人_会社コード ||--|{ 東京工場_プラント : "含む"
    日本法人_会社コード ||--|{ 大阪倉庫_プラント : "含む"
    日本法人_会社コード ||--|{ 国内営業部_販売組織 : "含む"
    日本法人_会社コード ||--|{ 国内調達部_購買組織 : "含む"
    国内調達部_購買組織 }o--o{ 東京工場_プラント : "任意の紐付け"
```

<div style="font-size: 0.8rem; color: #666; margin-top: 0.5rem; padding: 0.4rem 0.75rem; background: #f8f8f8; border-radius: 4px; display: flex; flex-wrap: wrap; gap: 0.25rem 1.5rem;">
  <span>凡例</span>
  <span><strong>||--|{</strong> 1対多（上位が下位を含む）</span>
  <span><strong>}o--o{</strong> 多対多（任意の紐付け）</span>
  <span>エンティティ名 = 具体例_組織エレメント種別</span>
</div>
